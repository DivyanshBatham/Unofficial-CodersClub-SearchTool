  ...
  constructor(props) {
    ...
    this.state = {
      cards: [
        ...
        { id:10, name: "Aditya Raj", skills: ['website development','Competitive Coding', 'C', 'C++', 'Python', 'Machine Learning'], imgSrc: 'https://avatars2.githubusercontent.com/u/36548874?s=460&v=4', isActive:false},
